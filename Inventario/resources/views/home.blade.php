...
<div style="text-align: center;" class="content">
    ...
    <img src="https://via.placeholder.com/300x200" alt="Imagen de inventario" style="display: block; margin: 20px auto;">
    <a href="{{ route('tareas') }}" class="btn btn-primary mt-3">Ir a Tareas</a>
</div>
